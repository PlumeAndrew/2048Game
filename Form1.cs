...
namespace WindowsFormGame_2048
{
    public partial class Form1 : Form
    {
        ...
        private void GenerateAllButtons()
        {
            ...
            for (int i = 0; i < btns.Length; i++)
            {
                ...
                btn.Text = Convert.ToString(board[r, c]);
        ...
        private void RefreshAllButtons()
        {
            for (int i = 0; i < btns.Length; i++)
            {
                int r = i / N;  //行
                int c = i % N;  //列
                btns[i].Text = Convert.ToString(board[r, c]);
        ...
        private void generateNewData()
        {
            ...
            board[nCount / N, nCount % N] =  2; //其值设为2
        }

        #region 关于四个方向移动的操作逻辑
        //上移
        private bool upMove()
        {
            bool isMoved = false;
